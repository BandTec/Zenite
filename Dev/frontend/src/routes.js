    ...
    <BrowserRouter>
        ...
        <Switch>
            ...
            <div className="conteudo">
                ...
                <PrivateRoute path="/motorista/detalhes/:id" component={DetalhesMotorista} />
                <PrivateRoute path="/motorista/editar/:id" component={CadastroMotorista} />
                <PrivateRoute path="/motorista/cadastro" component={CadastroMotorista} />

                {/* GERENTE */}
                <PrivateRoute exact path="/gerente" component={ConsultaGerente} />
                <PrivateRoute path="/gerente/detalhes/:id" component={DetalhesGerente} />
                ...
                <PrivateRoute path="/administrador/editar/:id" component={CadastroAdmin} />
                <PrivateRoute path="/administrador/cadastro" component={CadastroAdmin} />

                {/* LINHA */}
                <PrivateRoute path="/linha/detalhes/:id" component={DetalhesLinha} />
                <PrivateRoute path="/linha/editar/:id" component={CadastroParadaLinha} />
